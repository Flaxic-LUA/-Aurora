...
DF:NewModule('talents', 1, function() -- TODO: needs total rewrite
    ...
    local function CreateMainFrame()
        ...
        DF.setups.talentsBg = frame.Bg

        local closeButton = DF.ui.CreateRedButton(frame, 'close', function()
            frame:Hide()
            UpdateMicroButtons()
        end)
        closeButton:SetPoint('TOPRIGHT', frame, 'TOPRIGHT', 0, -1)

        local headerText = DF.ui.Font(frame, 13, 'Talents', {1, 1, 1}, 'CENTER')
        ...
        frame:SetScript('OnShow', function()
            ...
            local btn = getglobal('DF_MicroButton_Talents')
        ...
        frame:Hide()
        table.insert(UISpecialFrames, 'DF_TalentFrame')
    end
    ...
    local function CreateAllTalents()
        ...
        DF.setups.talentsTreeFrames = treeFrames
    end
