...
DF:NewDefaults('distance', {
    ...
    showPortrait = {value = true, metadata = {element = 'checkbox', category = 'General', indexInCategory = 3, description = 'Show target portrait', dependency = {key = 'showDistance', state = true}}},
    ...
    textSize = {value = 15, metadata = {element = 'slider', category = 'General', indexInCategory = 5, description = 'Text size', min = 8, max = 24, stepSize = 1, dependency = {key = 'showDistance', state = true}}},
    ...
    bgAlpha = {value = 0.1, metadata = {element = 'slider', category = 'General', indexInCategory = 7, description = 'Background opacity', min = 0, max = 1, stepSize = 0.05, dependency = {key = 'showDistance', state = true}}},
    portraitSpacing = {value = 1, metadata = {element = 'slider', category = 'General', indexInCategory = 8, description = 'Portrait spacing', min = 0.1, max = 5, stepSize = 0.1, dependency = {key = 'showDistance', state = true}}},
    ...
    barWidth = {value = 50, metadata = {element = 'slider', category = 'Bars', indexInCategory = 2, description = 'Bar width', min = 10, max = 100, stepSize = 5, dependency = {{key = 'showDistance', state = true}, {key = 'showBars', state = true}}}},
    barHeight = {value = 5, metadata = {element = 'slider', category = 'Bars', indexInCategory = 3, description = 'Bar height', min = 1, max = 30, stepSize = 1, dependency = {{key = 'showDistance', state = true}, {key = 'showBars', state = true}}}},
    barRepeat = {value = false, metadata = {element = 'checkbox', category = 'Bars', indexInCategory = 4, description = 'Repeat bar animation', dependency = {{key = 'showDistance', state = true}, {key = 'showBars', state = true}}}},
    barAnimInterval = {value = 0.03, metadata = {element = 'slider', category = 'Bars', indexInCategory = 5, description = 'Animation smoothness (lower = smoother)', min = 0.01, max = 0.1, stepSize = 0.01, dependency = {key = 'showDistance', state = true}}},
